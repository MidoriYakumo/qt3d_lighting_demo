...
Material {
	...
	property real refractive: 1.5
	property real transparency: 0.95
    ...
    ShaderProgram {
        ...
        fragmentShaderCode: loadSource("qrc:///phongglass.frag")
	}
	...
	effect: Effect {
		...
		parameters: [
			...
			Parameter { name: "refractive"; value: refractive},
			Parameter { name: "transparency"; value: transparency}
		]
